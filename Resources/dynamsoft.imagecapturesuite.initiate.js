...
(function(D) {
    ...
    var o = document.getElementById(this._strICSNonInstallInnerContainerID);
        ...
        var strObjString = ["<div style='display: block; border:solid black 1px; text-align:center; width:",
			...
			"<li>Please click \"Always run on this site\" for the prompt \"" + D.ICSProduct._strProductName + " Plugin needs your permission to run\", refresh/restart the browser and try again.</li>",
			"</ul></div>"].join('');
